      ...
      <div className="flex w-full justify-between">
        <div className="flex w-1/3">
          ...
          <div className="flex flex-col ml-3 w-full">
            <h5 className="full whitespace-nowrap overflow-hidden text-ellipsis">{props.user.name}</h5>
        ...
        <div className="flex w-2/3 justify-end items-center">
          <div className="flex items-start justify-between w-1/3"
            ...
            <h6
              className="w-full whitespace-nowrap font-bold text-MatBlue h-4 overflow-hidden text-ellipsis"
            >
